...
```
curl -v -X POST -d 'email=redacted@example.invalid&password=123456' https://api.tiledesk.com/auth/signup
```

### Signin

```
curl -v -X POST -d 'email=redacted@example.invalid&password=123456' https://api.tiledesk.com/auth/signin
```

### Firebase signin

```
curl -v -X POST -d 'email=redacted@example.invalid&password=123456' https://api.tiledesk.com/firebase/auth/signin
```

### Departments 

```
curl -v -X GET -u redacted@example.invalid:123456 https://api.tiledesk.com/5ab0f32757066e0014bfd718/departments
```

#### Get the available operator for a specific department
```
curl -v -X GET -u redacted@example.invalid:123456 https://api.tiledesk.com/5ad4c101e774ac0014ae0d07/departments/5ad5c2c9c975820014ba901b/operators
```
...
```
curl -v -X GET -u redacted@example.invalid:123456 https://api.tiledesk.com/5ab0f32757066e0014bfd718/faq_kb
```
