...
When building an API client, we recommend treating any 500 status codes as a warning or temporary state. However, if the status persists and we don't have a publicly announced maintenance or service disruption, contact us at redacted@example.invalid
...
```
curl -v -X GET -H 'Content-Type: application/json' -u redacted@example.invalid:123456 https://api.tiledesk.com/v1/5b55e806c93dde00143163dd/leads
```
...
```
curl -v -X GET -H 'Content-Type: application/json' -u redacted@example.invalid:123456 https://api.tiledesk.com/v1/5b55e806c93dde00143163dd/leads/5c81593adf767b0017d1aa66
```
...
```
curl -v -X POST -H 'Content-Type: application/json' -u redacted@example.invalid:123456  -d '{"fullanem":"andrea", "lead_id":"123456"}' https://api.tiledesk.com/v1/5b55e806c93dde00143163dd/leads
```
...
```
curl -v -X GET -H 'Content-Type: application/json' -u redacted@example.invalid:123456 https://api.tiledesk.com/v1/5b55e806c93dde00143163dd/requests
```
...
```
curl -v -X GET -H 'Content-Type: application/json' -u redacted@example.invalid:123456 https://api.tiledesk.com/v1/5b55e806c93dde00143163dd/requests/support-group-L_OG76RYhR0XFiMf2PK
```
