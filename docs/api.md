...
```
curl -v -X GET -u redacted@example.invalid:123456 https://api.tiledesk.com/v1/5b55e806c93dde00143163dd/leads
```
...
```
curl -v -X GET -u redacted@example.invalid:123456 https://api.tiledesk.com/v1/5b55e806c93dde00143163dd/leads/5c81593adf767b0017d1aa66
```
...
```
curl -v -X GET -u redacted@example.invalid:123456 https://api.tiledesk.com/v1/5b55e806c93dde00143163dd/requests
```
...
```
curl -v -X GET -u redacted@example.invalid:123456 https://api.tiledesk.com/v1/5b55e806c93dde00143163dd/requests/support-group-L_OG76RYhR0XFiMf2PK
```
