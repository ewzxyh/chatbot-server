                ...
                faqService.create("testbot", null, savedProject._id, savedUser._id, false).then(function(savedBot) {    
                    Department.findOneAndUpdate({id_project: savedProject._id, default:true}, {id_bot:savedBot._id}, function (err, updatedDepartment) {
                            ...
                            .end((err, res) => {
                                ...
                                leadService.createIfNotExists("leadfullname-subscription-message-create", "redacted@example.invalid", savedProject._id).then(function(createdLead) {
                    ...
                    faqService.create("testbot", null, savedProject._id, savedUser._id, false).then(function(savedBot) {    
                        Department.findOneAndUpdate({id_project: savedProject._id, default:true}, {id_bot:savedBot._id}, function (err, updatedDepartment) {
                                ...
                                .end((err, res) => {
                                    ...
                                    leadService.createIfNotExists("leadfullname-subscription-message-received", "redacted@example.invalid", savedProject._id).then(function(createdLead) {
