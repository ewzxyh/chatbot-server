...
describe('RequestService', function () {
  ...
  it('createSimpleRequest-quote', (done) => {
    ...
    userService.signup(email, pwd, "Test Firstname", "Test Lastname").then(((savedUser) => {
      leadService.createIfNotExists("leadfullname", "redacted@example.invalid", mockProject._id).then((createdLead) => {
        var now = Date.now();
        var request = {
  ...
  it('createObjSimple', function (done) {
    ...
    userService.signup(email, pwd, "Test Firstname", "Test lastname").then(function (savedUser) {
      ...
      projectService.createAndReturnProjectAndProjectUser("createWithId", savedUser.id).then(function (savedProjectAndPU) {
        ...
        leadService.createIfNotExists("leadfullname", "redacted@example.invalid", savedProject._id).then(function (createdLead) {
          var now = Date.now();
          var request = {
      ...
      projectService.createAndReturnProjectAndProjectUser("createWithId", userid).then(function (savedProjectAndPU) {
        ...
        leadService.createIfNotExists("leadfullname", "redacted@example.invalid", savedProject._id).then(function (createdLead) {
          ...
          requestService.create(request).then(function (savedRequest) {
            ...
            leadService.updateWitId(createdLead.lead_id, "fullname2", "redacted@example.invalid", savedProject._id).then(function (updatedLead) {
  ...
  //     leadService.createIfNotExists("leadfullname", "redacted@example.invalid",  savedProject._id).then(function(lead) {
  ...
  //        leadService.findByEmail("redacted@example.invalid", savedProject._id).then(function(lead) {
