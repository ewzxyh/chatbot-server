...
describe('Trigger', () => { 
    ...
    //                     leadService.createIfNotExists("leadfullname-trigger", "redacted@example.invalid", savedProject._id).then(function(createdLead) {
    ...
    //     });
        ...
        //                     leadService.createIfNotExists("leadfullname-trigger-ko", "redacted@example.invalid", savedProject._id).then(function(createdLead) {
