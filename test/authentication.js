...
process.env.ADMIN_EMAIL = "redacted@example.invalid";
...
describe('/signup', () => {
    ...
    //     chai.request(server)
    //         .post("/auth/signin")
    //         .send({ email: "redacted@example.invalid", password: "adminadmin" })
    //         .end((err, res) => {
...
describe('/signInAnonymously', () => {
        ...
        userService.signup( email ,pwd, "Test Firstname", "Test lastname").then(function(savedUser) {
            ...
            projectService.create("test-signInAnonymouslyOk", savedUser._id).then(function(savedProject) {     
                    ...
                    chai.request(server)
                        ...
                        .send({ id_project: savedProject._id, email: "redacted@example.invalid"})
                        .end((err, res) => {
                            //console.log("res",  res);
                            console.log("res.body",  res.body);
                            res.should.have.status(200);
    ...
    //                             .post('/auth/resigninAnonymously' )
    //                             .set('Authorization', token)
    //                             .send({ id_project: savedProjectDifferent._id, email: "redacted@example.invalid"})
    //                             .end((err, res) => {
    //                                 //console.log("res",  res);
    //                                 console.log("res.body",  res.body);
    //                                 res.should.have.status(200);
        ...
        userService.signup( email ,pwd, "Test Firstname", "Test lastname").then(function(savedUser) {
            ...
            projectService.create("test-signinWithCustomToken", savedUser._id).then(function(savedProject) {     
                ...
                .end((err, res) => {
                    ...
                    var externalUserObj = {_id: "123", firstname:"andrea", lastname:"leo", email: "redacted@example.invalid",  customAttr: "c1"};
    ...
    userService.signup( email ,pwd, "Test Firstname", "Test lastname").then(function(savedUser) {
        ...
        projectService.create("test-signinWithCustomTokenKONoID", savedUser._id).then(function(savedProject) {     
            ...
            .end((err, res) => {
                ...
                // 'E11000 duplicate key error collection: tiledesk-test.users index: email_1 dup key: { email: "redacted@example.invalid" }' }
                var externalUserObj = {firstname:"andrea", lastname:"leo", email: "redacted@example.invalid"};
    ...
    userService.signup( email ,pwd, "Test Firstname", "Test lastname").then(function(savedUser) {
        ...
        projectService.create("test-signinWithCustomTokenKOWrongAud", savedUser._id).then(function(savedProject) {     
            ...
            .end((err, res) => {
                ...
                // 'E11000 duplicate key error collection: tiledesk-test.users index: email_1 dup key: { email: "redacted@example.invalid" }' }
                var externalUserObj = {_id: 1234, firstname:"andrea", lastname:"leo", email: "redacted@example.invalid"};
