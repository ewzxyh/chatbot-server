    ...
    userService.signup(email, pwd, "Test Firstname", "Test lastname").then(function (savedUser) {
      projectService.createAndReturnProjectAndProjectUser("message-createwithsender", savedUser._id).then(function (savedProjectAndPU) {
        ...
        pu.save(function (err, savedProject_user) {
          ...
          leadService.createIfNotExistsWithLeadId(uid, "leadfullname", "redacted@example.invalid", savedProject._id).then(function (createdLead) {
  ...
  it('getall', function (done) {
    ...
    userService.signup(email, pwd, "Test Firstname", "Test lastname").then(function (savedUser) {
      ...
      projectService.createAndReturnProjectAndProjectUser("message-create", savedUser._id).then(function (savedProjectAndPU) {
        ...
        leadService.createIfNotExists("leadfullname-message-getall", "redacted@example.invalid", savedProject._id).then(function (createdLead) {
        ...
        projectService.create("test-sendMessageSigninWithCustomTokenOk", savedUser._id).then(function (savedProject) {
          ...
          chai.request(server)
            ...
            .end((err, res) => {
              ...
              // 'E11000 duplicate key error collection: tiledesk-test.users index: email_1 dup key: { email: "redacted@example.invalid" }' }
              var externalUserId = "123";
              var externalUserObj = { _id: externalUserId, firstname: "andrea", lastname: "leo", email: "redacted@example.invalid" };
              ...
              chai.request(server)
                ...
                .end((err, res) => {
                  ...
                  expect(res.body.user.email).to.equal("redacted@example.invalid");
                    ...
                    .end(function (err, res) {
                      ...
                      chai.request(server)
                        ...
                        .end(function (err, res) {
                          ...
                          expect(res.body.lead.email).to.equal("redacted@example.invalid");
                ...
                .end((err, res) => {
                  ...
                  chai.request(server)
                    ...
                    .end(function (err, res) {
                      ...
                      expect(res.body.request.department).to.not.equal(null);
                      expect(res.body.request.lead).to.not.equal(null);
                      expect(res.body.request.lead.email).to.equal("redacted@example.invalid");
                      ...
                      chai.request(server)
                        ...
                        .end(function (err, res) {
                          ...
                          externalUserObj.email = "redacted@example.invalid";
