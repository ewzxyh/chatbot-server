...
class Chat21Handler {
    ...
    listen() {
        ...
        // {"firstname":"Andrea","lastname":"Leo","email":"redacted@example.invalid"}
            ...
            setImmediate(() => {
                   ...
                   if (message && message.status === MessageConstants.CHAT_MESSAGE_STATUS.SENDING && message.request && message.request.channel.name === ChannelConstants.CHAT21) {
                    // if (message && message.status === MessageConstants.CHAT_MESSAGE_STATUS.SENDING) {
                        ...
                        //'https://us-central1-chat21-pre-01.cloudfunctions.net/api/tilechat/typings/support-group-LvtMo6VMxX1j3xV3b-X?token=[REDACTED_TOKEN],',
