...
class EmailService {
  ...
  constructor() {
    ...
    if (this.pass) {
      maskedemailPassword = REDACTED_SECRET(this.pass, maskOptions);
    } else {
    ...
    this.ccEnabled = false //cc creates loop when you send an email with cc: redacted@example.invalid -> Tiledesk generates an email with ticket id with in cc redacted@example.invalid that loop 
