...
class EmailService {
  ...
  constructor() {
    ...
    if (this.emailPassword) {
      maskedemailPassword = REDACTED_SECRET(this.emailPassword, maskOptions);
    }else {
  ...
  send(to, subject, html) {
    ...
    this.getTransport().sendMail(mailOptions, (error, info) => {
      ...
      // Message sent: <redacted@example.invalid>
                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                ...
                                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                  ...
                                  <td class="content-block" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;" valign="top">
                                    ...
                                    <br><br>If this wasn't you please contact <a href="mailto:redacted@example.invalid">our support team</a>
                      ...
                      <table width="100%" cellpadding="0" cellspacing="0" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                        ...
                        <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                          <td class="content-block" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;" valign="top">
                            ...
                            <br><br>Give us your feedback! We need your advice. Send an email to <a href="mailto:redacted@example.invalid">redacted@example.invalid</a>
                            <br><br> Team TileDesk
                          </td>
                        </tr>
...
emailService.sendTest("redacted@example.invalid");
