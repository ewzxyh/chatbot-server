            ...
            Faq.find({ id_faq_kb: id_faq_kb }, (err, faqs) => {
                ...
                if (err) {
                    ...
                    let json = {
                        ...
                        // curl -v -X PUT -H 'Content-Type:application/json' -u redacted@example.invalid:adminadmin -d '{"trained":false}'  http://localhost:3000/63ed15febb8a5eb3b247fdfd/bots/64551b3422cdfb93ddb1b784
