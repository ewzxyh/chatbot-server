                        ...
                        updatedBy: savedUser._id
                                ...
                                Department.findOneAndUpdate({id_project: savedProject._id, default:true}, {id_bot:savedBot._id}, function (err, updatedDepartment) {
                                        ...
                                        .end((err, res) => {
                                            ...
                                            leadService.createIfNotExists("leadfullname-subscription-message-sending", "redacted@example.invalid", savedProject._id).then(function(createdLead) {
                                ...
                                Department.findOneAndUpdate({id_project: savedProject._id, default:true}, {id_bot:savedBot._id}, function (err, updatedDepartment) {
                                    console.log('000');
                                        ...
                                        .end((err, res) => {
                                            ...
                                            leadService.createIfNotExists("leadfullname-subscription-message-sending-createSimpleAgent", "redacted@example.invalid", savedProject._id).then(function(createdLead) {
                            ...
                            updatedBy: savedUser._id
                                    ...
                                    Department.findOneAndUpdate({id_project: savedProject._id, default:true}, {id_bot:savedBot._id}, function (err, updatedDepartment) {
                                            ...
                                            .end((err, res) => {
                                                ...
                                                leadService.createIfNotExists("leadfullname-subscription-message-sending-createNotFoundDefaultFallback", "redacted@example.invalid", savedProject._id).then(function(createdLead) {
