...
//  curl -v -X PUT -H 'Content-Type:application/json' -u redacted@example.invalid:123456 -d '{"first_text":"ciao"}' http://localhost:3000/68d4135a10e71f7bfa4dcf2f/requests/req123456/reopen
// TODO make a synchronous chat21 version (with query parameter?) with request.support_group.created
...
// curl -v -X POST -H 'Content-Type:application/json' -u redacted@example.invalid:123456 -d '{"member":"ciao"}' http://localhost:3000/68d4135a10e71f7bfa4dcf2f/requests/req123456/participants
// TODO make a synchronous chat21 version (with query parameter?) with request.support_group.created
...
//  curl -v -X PUT -H 'Content-Type:application/json' -u redacted@example.invalid:123456 -d '{"member":"ciao"}' http://localhost:3000/68d4135a10e71f7bfa4dcf2f/requests/req123456/participants
...
// curl -v -X DELETE -H 'Content-Type:application/json' -u redacted@example.invalid:123456 -d '{"member":"ciao"}' http://localhost:3000/68d4135a10e71f7bfa4dcf2f/requests/req123456/participants/12
// TODO make a synchronous chat21 version (with query parameter?) with request.support_group.created
...
// curl -v -X GET -H 'Content-Type:application/json' -u redacted@example.invalid:123456 http://localhost:3000/68d4135a10e71f7bfa4dcf2f/requests
