...
curl -u redacted@example.invalid:123456 \
  ...
  curl -u redacted@example.invalid:123 \ 
  -F "file=@/Users/andrealeo/dev/chat21/tiledesk-server-dev-org/test.jpg" \
...
curl -v -X PUT -u redacted@example.invalid:123456 \
  ...
  curl -v -X PUT -u redacted@example.invalid:123 \
  -F "file=@/Users/andrealeo/dev/chat21/tiledesk-server-dev-org/test.jpg" \
    https://tiledesk-server-pre.herokuapp.com/images/users/
