...
// curl -v -X POST -H 'Content-Type:application/json' -u redacted@example.invalid:258456td -d '{"senderFullname":"Bot","recipient":"USERID", "text":"ciao"}' https://tiledesk-server-pre.herokuapp.com/5f86c201189063003453a045/messages/
// curl -v -X POST -H 'Content-Type:application/json' -u redacted@example.invalid:123456 -d '{"senderFullname":"Bot","recipient":"USERID", "text":"ciao"}' http://localhost:3000/609e3fd8e049553972114b88/messages/
