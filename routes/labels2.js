...
// curl -v -X PATCH -H 'Content-Type:application/json' -u redacted@example.invalid:123456 -d '{"lang":"FR", "data":{"a":"b","c":"d"}}' http://localhost:3000/4321/labels2/
...
// curl -v -X DELETE -H 'Content-Type:application/json' -u redacted@example.invalid:123456 http://localhost:3000/1235/labels2/EN
