...
// curl -v -X POST -H 'Content-Type:application/json' -u redacted@example.invalid:123456 -d '{"text":"ciao"}' http://localhost:3000/5f897142c9e7ad9602a744c9/campaigns/
// curl -v -X POST -H 'Content-Type:application/json' -u redacted@example.invalid:123456 -d '{"text":"ciao", "leadid":"213213221"}' http://localhost:3000/5f897142c9e7ad9602a744c9/campaigns/


// curl -v -X POST -H 'Content-Type:application/json' -u redacted@example.invalid:258456 -d '{"text":"ciao", "leadid":"5f8972c82db41c003473cb03"}' https://tiledesk-server-pre.herokuapp.com/5f86c201189063003453a045/campaigns/
// curl -v -X POST -H 'Content-Type:application/json' -u redacted@example.invalid:258456 -d '{"text":"ciao", "leadid":"5f8972c82db41c003473cb03", "request_id":"group-123456789112233"}' https://tiledesk-server-pre.herokuapp.com/5f86c201189063003453a045/campaigns/
...
// curl -v -X POST -H 'Content-Type:application/json' -u redacted@example.invalid:258456 -d '{"text":"ciao", "recipient":"5f8972c82db41c003473cb03"}' https://tiledesk-server-pre.herokuapp.com/5f86c201189063003453a045/campaigns/direct
