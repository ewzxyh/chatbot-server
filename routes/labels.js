...
// curl -v -X POST -H 'Content-Type:application/json' -u redacted@example.invalid:123456 -d '{"lang":"IT"}' http://localhost:3001/624c78e27b91d2a2ab49543a/labels/default/clone
...
// Update labels
// curl -v -X PATCH -H 'Content-Type:application/json' -u redacted@example.invalid:123456 -d '{"lang":"FR", "data":{"a":"b","c":"d"}}' http://localhost:3000/4321/labels/EN/default
...
// Update labels
// curl -v -X POST -H 'Content-Type:application/json' -u redacted@example.invalid:123456 -d '{"lang":"FR", "data":{"a":"b","c":"d"}}' http://localhost:3000/4321/labels/
...
// curl -v -X DELETE -H 'Content-Type:application/json' -u redacted@example.invalid:123456 http://localhost:3000/4321/labels/
...
// curl -v -X DELETE -H 'Content-Type:application/json' -u redacted@example.invalid:123456 http://localhost:3000/1235/labels/EN
