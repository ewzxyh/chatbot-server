      ...
      return new Promise(function (resolve, reject) {
        ...
        return q.exec(function (err, project) {
          ...
          if (topic.endsWith('/messages')) {
            ...
            //curl -v -X PUT -H 'Content-Type:application/json' -u redacted@example.invalid:123456 -d '{"user_available":false}' http://localhost:3000/5e71139f61dd040bc9594cee/project_users/
