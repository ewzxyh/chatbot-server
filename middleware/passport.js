...
var maskedconfigSecret = REDACTED_SECRET(configSecret, maskOptions);
...
module.exports = function(passport) {
  ...
  var opts = {
            ...
            secretOrKeyProvider: function(request, rawJwtToken, done) {
              ...
              // if (request.project) {
              //   winston.info("secretOrKeyProvider.request.project.jwtSecret: "REDACTED_SECRET );
              // }
