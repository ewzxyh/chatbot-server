...
curl -v -X POST -H 'Content-Type:application/json' -u redacted@example.invalid:123456 -d '{"sender":"io", "sender_fullname":"Andrea Leo", "text":"firstText"}' http://localhost:3000/5d2a600039fc8e04ae4ffaee/requests/req123456789/messages
curl -v -X PUT -H 'Content-Type:application/json' -u redacted@example.invalid:123456  http://localhost:3000/5d2a600039fc8e04ae4ffaee/requests/req123456789/close
